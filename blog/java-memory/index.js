setTimeout(function () {
  ...
  function showReleases(arr) {
    ...
    for (i = 0; i < Object.keys(arr).length; i++) {
      ...
      console.log("Anzahl von Release-Versionen: " + name.length)
    }
    for (z = 0; z < name.length; z++) {
      out +=
        ...
        "<h3 class='d-inline'>Assets</h3><span title='4' data-view-component='true' class='Counter ml-1'>4</span>" +
        "</summary>" +
